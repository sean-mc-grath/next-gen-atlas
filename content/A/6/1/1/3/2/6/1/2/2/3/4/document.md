...
###### A.6.1.1.3.2.6.1.2.2.3.4 - USDS Burn Action [Core]
...
`
More detailed instructions on the code to execute this, see [A.6.1.1.3.2.6.1.2.2.1.2.1.2.1.2 - Burn USDS](25706c25-2b74-486e-8234-c45f6630f379).
