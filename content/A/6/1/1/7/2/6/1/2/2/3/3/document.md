...
###### A.6.1.1.7.2.6.1.2.2.3.3 - USDC To USDS Swap Action [Core]
...
For more detailed instructions on the code to execute this see [A.6.1.1.7.2.6.1.2.2.1.2.1.2.6.2 - Swap USDC To USDS](9d828ddb-7423-41cb-9adb-43d4cbfc9d38).
